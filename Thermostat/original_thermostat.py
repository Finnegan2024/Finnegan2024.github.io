...
class TemperatureMachine(StateMachine):
    ...
    def on_exit_cool(self):
        ## ensure blue light is off when exiting cool state
        blueLight.off()
    ...
    def processTempStateButton(self):
        ...
        ## simply call cycle method for state machine object to cycle through states
        self.cycle()
    ...
    def processTempIncButton(self):
        ...
        ## inc set point by 1 every time method is called and leverage updateLights method to reflect LEDs functionality properly
        self.setPoint += 1
        self.updateLights()
    ...
    def processTempDecButton(self):
        ...
        ## dec set point by 1 every time method is called and leverage updateLights method
        self.setPoint -= 1
        self.updateLights()
    ...
    def updateLights(self):
        ...
        ## match-case statements for readbility
        match currState:
            case "heat":
    ...
    def setupSerialOutput(self):
        ## string to send to server with comma delimited values
        output = f"State: {self.current_state.id}, Temp: {floor(self.getFahrenheit())}F, SetPoint: {self.setPoint}F"
        return output
    ...
    def manageMyDisplay(self):
        ...
        while not self.endDisplay:
            ...
            if(altCounter < 6):
                ## 2nd line with current temp
                lcd_line_2 = f"Curr Temp: {floor(self.getFahrenheit())}F"
    
                altCounter = altCounter + 1
            else:
                ## 2nd line with current state and setpoint vals
...
##
# changing to gray button to reflect my setup
